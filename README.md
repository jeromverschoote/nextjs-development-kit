...
```
cd nextjs-development-kit && git checkout blockchain && yarn
```
...
- [Venly Wallet](https://www.venly.io/) - A crypto wallet solution, mainly for connecting users via email or social.
